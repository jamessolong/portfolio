      ...
      <section class="ftco-fixed clearfix">
      	...
      	<div class="page-container contact-section float-right">
            ...
            <div class="col-md-12 mb-4">
              <h2 class="h4">ข้อมูลการติดต่อ</h2>
            </div>
            <div class="w-100"></div>
            <div class="col-md-3">
              <p><span>ที่อยู่:</span> 169 ถ.ลงหาดบางแสน ต.แสนสุข อ.เมือง จ.ชลบุรี 20131</p>
            </div>
            <div class="col-md-3">
              <p><span>หมายเลขติดต่อ:</span> <a href="tel://1234567920">0884580690</a></p>
            </div>
            <div class="col-md-3">
              <p><span>Email:</span> <a href="mailto:info@yoursite.com">59160942@go.buu.ac.th</a></p>
            </div>
            <div class="col-md-3">
              <p><span>Facebook</span> <a href="#">James Solong</a></p>
            </div>
          </div>
