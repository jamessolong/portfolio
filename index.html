      ...
      <section class="ftco-fixed clearfix">
      	...
      	<div class="page-container float-right">
      		<div class="row">
                ...
                <div class="text py-4">
                  <div class="meta">
                    <div><a href="#">July 2, 2018</a></div>
                    
                  </div>
                  <h3 class="heading"><a href="#">Pause Resort </a></h3>
                  <p>Pause Resort เกาะล้าน</p>
                </div>
              </div>
              <div class="blog-entry ftco-animate">
                <a href="blog-single.html" class="blog-image">
                ...
                <div class="text py-4">
                  <div class="meta">
                    <div><a href="#">September 27, 2017</a></div>
                   
                  </div>
                  <h3 class="heading"><a href="#">A Loft</a></h3>
                  <p>Relax time</p>
                </div>
              </div>
              <div class="blog-entry ftco-animate">
                ...
                <div class="text py-4">
                  <div class="meta">
                    <div><a href="#">June 21, 2017</a></div>
                   
                  </div>
                  <h3 class="heading"><a href="#">BUU</a></h3>
                  <p>Informatics @ BUU</p>
                </div>
              </div>
                ...
                <div class="text py-4">
                  <div class="meta">
                    <div><a href="#">July 1, 2018</a></div>
                   
                  </div>
                  <h3 class="heading"><a href="#">หาดแสม</a></h3>
                  <p>หาดแสม เกาะล้าน วันแรก</p>
                </div>
              </div>
              <div class="blog-entry ftco-animate">
                <a href="blog-single.html" class="blog-image">
                ...
                <div class="text py-4">
                  ...
                  <h3 class="heading"><a href="#">หาดเทียน</a></h3>
                  <p>หาดเทียน เกาะล้าน  15.35 pm</p>
                </div>
              </div>
